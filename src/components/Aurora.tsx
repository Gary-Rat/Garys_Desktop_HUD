...
export default function Aurora({
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      const width = activeContainer.offsetWidth
    ...
    const toColorStopArray = (stops: string[]) =>
      stops.map((hex) => {
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColorStops: { value: toColorStopArray(colorStops) },
    ...
    const update = (tick: number) => {
      ...
      program.uniforms.uColorStops.value = toColorStopArray(propsRef.current.colorStops)
